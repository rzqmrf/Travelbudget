            ...
            <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-8">
                <form method="POST" action="{{ route('vehicles.store') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name')" required autofocus placeholder="Contoh: Honda Vario, Toyota Avanza" />
                    ...
                    <div>
                        ...
                        <select id="type" name="type" class="block mt-1 w-full border-slate-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-xl shadow-sm">
                            <option value="motor" {{ old('type') == 'motor' ? 'selected' : '' }}>🏍️ Motor</option>
                    ...
                    <div>
                        ...
                        <x-text-input id="fuel_consumption" class="block mt-1 w-full" type="number" step="0.1" name="fuel_consumption" :value="old('fuel_consumption')" required placeholder="Contoh: 45.5 (untuk motor), 12.0 (untuk mobil)" />
                        <p class="text-xs text-slate-400 mt-1">Estimasi seberapa jauh kendaraan dapat menempuh jarak dalam 1 liter bahan bakar.</p>
                    ...
                    <div>
                        ...
                        <x-text-input id="fuel_type" class="block mt-1 w-full" type="text" name="fuel_type" :value="old('fuel_type', 'Pertalite')" required placeholder="Contoh: Pertalite, Pertamax, Solar" />
                    ...
                    <div>
                        ...
                        <x-text-input id="fuel_price" class="block mt-1 w-full" type="number" name="fuel_price" :value="old('fuel_price', 10000)" required placeholder="Contoh: 10000, 12950" />
                    ...
                    <div class="block">
                        <label for="is_default" class="inline-flex items-center">
                            <input id="is_default" type="checkbox" class="rounded border-slate-300 text-indigo-600 shadow-sm focus:ring-indigo-500" name="is_default" value="1" {{ old('is_default') ? 'checked' : '' }}>
